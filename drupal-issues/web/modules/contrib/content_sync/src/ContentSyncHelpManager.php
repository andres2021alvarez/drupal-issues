...
(Description of the proposed solution, the rationale behind it, and workarounds for people who cannot use the patch.)",
  ...
  public function buildAbout() {
    ...
    $this->t('Feature requests can be added to the Content Sync modules issue queue. Use the same tips provided
    for creating issue reports to help you author a feature request. The better you can define your needs and ideas,
     the easier it will be for people to help you.') . '</p>';
  ...
  protected function initHelp() {
    ...
    $help['content_export_full'] = [
      ...
      'content' => $this->t('Create and download an archive consisting of all your sites content exported as <em>*.yml</em> files as a gzipped tar file.'),
      'menu' => TRUE,
    ];
