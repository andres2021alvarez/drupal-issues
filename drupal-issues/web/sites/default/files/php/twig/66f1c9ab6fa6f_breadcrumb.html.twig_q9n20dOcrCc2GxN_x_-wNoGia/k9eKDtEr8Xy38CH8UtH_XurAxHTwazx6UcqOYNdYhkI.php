...
class __TwigTemplate_c3f37250351eded0356030065318d07a extends Template
{
    ...
    ";
        ...
        ";
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 18)) {
                    // line 19
                    yield "          <a href=\"";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 19), 19, $this->source), "html", null, true);
                    yield "\">";
